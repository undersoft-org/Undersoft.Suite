...
/// <summary>
/// Unit tests for the type <see cref="AdminDictionaries"/>.
/// </summary>
[TestClass]
public class AdminDictionariesTests
{
    private AdminDictionaries _testClass;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="AdminDictionaries"/>.
    /// </summary>
    [TestInitialize]
    public void SetUp()
    {
        this._testClass = new AdminDictionaries();
    }
    ...
    {
        // Arrange
        var testValue = "TestValue1364044964";
    ...
    {
        // Arrange
        var testValue = "TestValue1842461176";
