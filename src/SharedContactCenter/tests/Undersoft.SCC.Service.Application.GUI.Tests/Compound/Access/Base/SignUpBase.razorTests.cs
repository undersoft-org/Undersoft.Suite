...
/// <summary>
/// Unit tests for the type <see cref="SignUpBase"/>.
/// </summary>
[TestClass]
public partial class SignUpBaseTests
{
    private SignUpBase _testClass;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="SignUpBase"/>.
    /// </summary>
    [TestInitialize]
    public void SetUp()
    {
        this._testClass = new SignUpBase();
    }
