...
/// <summary>
/// Unit tests for the type <see cref="SignInBase"/>.
/// </summary>
[TestClass]
public partial class SignInBaseTests
{
    private SignInBase _testClass;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="SignInBase"/>.
    /// </summary>
    [TestInitialize]
    public void SetUp()
    {
        this._testClass = new SignInBase();
    }
