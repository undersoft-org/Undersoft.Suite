...
public class Account : Authorization, IContract
{
    ...
    [RubricSize(64)]
    [DisplayRubric("Email")]
    public virtual string? Email { get => Personal?.Email; set => (Personal ??= new AccountPersonal()).Email = value!; }
    ...
    public virtual string? PhoneNumber { get => Personal?.PhoneNumber; set => (Personal ??= new AccountPersonal()).PhoneNumber = value!; }
    ...
    public string? Image { get => Personal?.Image; set => (Personal ??= new AccountPersonal()).Image = value!; }

    [JsonIgnore]
    [IgnoreDataMember]
    public byte[]? ImageData { get => Personal?.ImageData; set => (Personal ??= new AccountPersonal()).ImageData = value!; }
