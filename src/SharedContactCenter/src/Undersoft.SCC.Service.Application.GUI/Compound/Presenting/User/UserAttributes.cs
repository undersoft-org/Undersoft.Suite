...
/// </summary>
public class UserAttributes : DataObject
{
    /// <summary>
    ...
    public string Groups { get; set; } = "/presenting/user/attributes/groups";
    /// <summary>
    /// The groups icon.
    /// </summary>
    ...
    public string Details { get; set; } = "/presenting/user/attributes/details";
    /// <summary>
    /// The countries icon.
    /// </summary>
    ...
    public string Settings { get; set; } = "/presenting/user/attributes/settings";
    /// <summary>
    /// The countries icon.
    /// </summary>
