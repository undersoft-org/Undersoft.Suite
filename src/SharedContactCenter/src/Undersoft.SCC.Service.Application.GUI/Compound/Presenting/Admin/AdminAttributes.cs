...
/// </summary>
public class AdminAttributes : DataObject
{
    /// <summary>
    ...
    public string Groups { get; set; } = "/presenting/admin/attributes/groups";
    /// <summary>
    /// The groups icon.
    /// </summary>
    ...
    public string Details { get; set; } = "/presenting/admin/attributes/details";
    /// <summary>
    /// The countries icon.
    /// </summary>
    ...
    public string Settings { get; set; } = "/presenting/admin/attributes/settings";
    /// <summary>
    /// The countries icon.
    /// </summary>
