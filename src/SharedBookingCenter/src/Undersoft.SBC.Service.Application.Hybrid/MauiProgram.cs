...
using Undersoft.SBC.Service.Application.GUI.Compound.Access;
    ...
    public static MauiApp CreateMauiApp()
    {
        var stream = Assembly
            ...
            .GetManifestResourceStream(
                $"Undersoft.SBC.Service.Application.Hybrid."
                    + (
        ...
        builder.ConfigureContainer(
            ...
            (services) =>
            {
                ...
                reg.AddAuthorizationCore()
                    ...
                    .AddScoped<IRemoteRepository<IDataStore, Contracts.Application>, RemoteRepository<IDataStore, Contracts.Application>>()
