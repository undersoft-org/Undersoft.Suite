...
namespace Undersoft.GDC.Tests.Domain.Entities;
...
public class DetailTests
{
    ...
    {
        this._testClass.CheckProperty(x => x.RelatedFrom, new EntitySet<Detail>(), new EntitySet<Detail>());
    }
    ...
    {
        this._testClass.CheckProperty(x => x.RelatedTo, new EntitySet<Detail>(), new EntitySet<Detail>());
    }
