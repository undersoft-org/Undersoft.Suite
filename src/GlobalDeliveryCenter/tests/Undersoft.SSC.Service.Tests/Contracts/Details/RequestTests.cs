...
/// <summary>
/// Unit tests for the type <see cref="Request"/>.
/// </summary>
[TestClass]
public class RequestTests
{
    private Request _testClass;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Request"/>.
    /// </summary>
    [TestInitialize]
    public void SetUp()
    {
        this._testClass = new Request();
    }
