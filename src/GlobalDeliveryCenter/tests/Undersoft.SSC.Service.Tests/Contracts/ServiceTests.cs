...
using Undersoft.GDC.Service.Contracts.Locations;

namespace Undersoft.GDC.Service.Tests.Contracts;
...
{
    private Undersoft.GDC.Service.Contracts.Service _testClass;
    ...
    public void SetUp()
    {
        this._testClass = new Undersoft.GDC.Service.Contracts.Service();
    }
