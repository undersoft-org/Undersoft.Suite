...
public class GeneralizedChangedSetHandler<TStore, TEntity, TDto>
    : INotificationHandler<GeneralizedChangedSet<TStore, TEntity, TDto>>
    ...
    where TStore : IDataServerStore
{
    ...
    public GeneralizedChangedSetHandler() { }
    ...
    public virtual async Task Handle(
        GeneralizedChangedSet<TStore, TEntity, TDto> request,
                ...
                if (request.PublishMode == EventPublishMode.PropagateCommand)
                {
                    ...
                    if (request.Predicate == null)
                        entities = _repository
                            .GeneralizedPatchBy(request.Select(d => d.Command.Contract))
                            .ToListing();
                    else
                        entities = _repository
                            .GeneralizedPatchBy(
