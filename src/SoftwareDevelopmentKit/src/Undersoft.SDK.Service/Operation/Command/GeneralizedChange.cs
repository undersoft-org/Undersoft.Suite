...
public class GeneralizedChange<TStore, TEntity, TDto> : Command<TDto>
    ...
    where TStore : IDataServerStore
{
    ...
    public GeneralizedChange(EventPublishMode publishMode, TDto input, params object[] keys)
        : base(OperationType.Change, publishMode, input, keys) { }

    public GeneralizedChange(
