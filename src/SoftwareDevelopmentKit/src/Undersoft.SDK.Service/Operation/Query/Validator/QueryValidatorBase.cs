...
public abstract class QueryValidatorBase<TQuery> : AbstractValidator<TQuery>
    where TQuery : IQuery
{
    ...
    public QueryValidatorBase(IServicer ultimateService)
    {
        _servicer = ultimateService;
    }
